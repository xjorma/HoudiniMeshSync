...
{
    float depth = LinearEyeDepth(SAMPLE_DEPTH_TEXTURE(_FAKEDepthTexture, sampler_FAKEDepthTexture, i.texcoordStereo));
...
half4 FragTempFilter(VaryingsDefault i) : SV_Target
{
    ...
    half4 cocTL = GATHER_RED_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - uvOffs.xy * 0.5, _MainTex_TexelSize.xy))); // top-left
    half4 cocBR = GATHER_RED_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + uvOffs.xy * 0.5, _MainTex_TexelSize.xy))); // bottom-right
    ...
    half coc1 = SAMPLE_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - uvOffs.xz, _MainTex_TexelSize.xy))).r; // top
    half coc2 = SAMPLE_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - uvOffs.zy, _MainTex_TexelSize.xy))).r; // left
    half coc3 = SAMPLE_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + uvOffs.zy, _MainTex_TexelSize.xy))).r; // bottom
    half coc4 = SAMPLE_TEXTURE2D(_CoCTex, sampler_CoCTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + uvOffs.xz, _MainTex_TexelSize.xy))).r; // right
...
half4 FragPrefilter(VaryingsDefault i) : SV_Target
{
    ...
    float2 uv0 = UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - duv.xy, _MainTex_TexelSize.xy));
    float2 uv1 = UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - duv.zy, _MainTex_TexelSize.xy));
    float2 uv2 = UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + duv.zy, _MainTex_TexelSize.xy));
    float2 uv3 = UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + duv.xy, _MainTex_TexelSize.xy));
...
half4 FragBlur(VaryingsDefault i) : SV_Target
{
    ...
    for (int si = 0; si < kSampleCount; si++)
    {
        ...
        half4 samp = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + duv, _MainTex_TexelSize.xy)));
...
half4 FragPostBlur(VaryingsDefault i) : SV_Target
{
    ...
    half4 acc;
    acc  = SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - duv.xy, _MainTex_TexelSize.xy)));
    acc += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord - duv.zy, _MainTex_TexelSize.xy)));
    acc += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + duv.zy, _MainTex_TexelSize.xy)));
    acc += SAMPLE_TEXTURE2D(_MainTex, sampler_MainTex, UnityStereoTransformScreenSpaceTex(ViewClampedUV(i.texcoord, i.texcoord + duv.xy, _MainTex_TexelSize.xy)));
    return acc / 4.0;
}
