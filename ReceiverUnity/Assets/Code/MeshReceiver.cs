...
public class MeshReceiver : MonoBehaviour
{
    ...
    private ConcurrentQueue<Tuple<int[],Vector3[], Vector3[]>> meshDataQueue = new ConcurrentQueue<Tuple<int [],Vector3[], Vector3[]>>();
    ...
    void Receiver()
    {
        ...
        while (true)
        {
            ...
            meshDataQueue.Enqueue(Tuple.Create(indices,points, normals));
        }
    }
